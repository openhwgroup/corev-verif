...
class cvxif_extn_t : public extension_t
{
 public:
  ...
  virtual reg_t cvxif_cus_add_rs3_madd(cvxif_insn_t insn);
  virtual reg_t cvxif_cus_add_rs3_msub(cvxif_insn_t insn);
  virtual reg_t cvxif_cus_add_rs3_nmadd(cvxif_insn_t insn);
  virtual reg_t cvxif_cus_add_rs3_nmsub(cvxif_insn_t insn);
  virtual reg_t cvxif_cus_add_rs3_rtype(cvxif_insn_t insn);
  virtual reg_t cvxif_cus_cnop(cvxif_insn_t insn);
  virtual reg_t cvxif_cus_cadd(cvxif_insn_t insn);
